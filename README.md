<div align="center">
  ...
  <p>
    ...
    <a href="https://yuzhiqiang.blog.csdn.net/" target="_blank">
      <img src="https://img.shields.io/badge/CSDN-博客专栏-FC5531?style=flat-square&logo=c-s-d-n&logoColor=white" alt="CSDN"/>
    </a>
    <a href="mailto:zhiqiang.yu.xeon@gmail.com">
      <img src="https://img.shields.io/badge/Email-zhiqiang.yu.xeon%40gmail.com-EA4335?style=flat-square&logo=gmail&logoColor=white" alt="Email"/>
    </a>
  </p>
...
我是一名专注于移动端架构与跨端工程的 **Android 研发工程师**，同时也是活跃的开源与 AI 工具链探索者。

- 📱 **移动端深耕**：专注于 Android 性能优化、组件化架构演进、现代 Kotlin 协程/Flow 响应式编程与混合容器技术。
- 🦀 **全栈与系统探索**：拓展 Rust / Tauri 跨平台桌面端应用开发，追求高可靠性与极致性能。
- 🤖 **AI 提效实践**：深度拥抱 AI Agent 协同编程，构建基于 LLM 的工程化提效工具链。
- ✍️ **知识沉淀与分享**：在 CSDN 等社区持续输出深度技术文章，坚信技术分享与交流是共同成长的最好催化剂。

---

### 🛠️ 技能与技术栈 (Tech Stack & Ecosystem)
...
| 项目名称 | 简介与核心亮点 | 主要技术 |
| :--- | :--- | :--- |
| [**📱 zxing**](https://github.com/yuzhiqiang1993/zxing) | 开箱即用的 Android 二维码/条码极速扫描方案，优化解码算法，支持自定义扫码框样式与相册解析 | `Kotlin` `Camera` `Android SDK` |
| [**🦀 agy-byok**](https://github.com/yuzhiqiang1993/agy-byok) | Google Antigravity BYOK 智能代理桌面端，支持主流大模型接入与上下文智能压缩 | `Rust` `Tauri` `AI Agent` |
| [**🔄 bsdiff**](https://github.com/yuzhiqiang1993/bsdiff) | Android 端文件与 APK 增量差分更新方案，基于 bsdiff 差分算法与 JNI 底层集成 | `C/C++` `JNI` `NDK` `Java` |

#### 🛠️ Android 现代架构与工具箱 (Architecture & Toolkits)
